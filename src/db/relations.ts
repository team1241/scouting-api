...
import { actions, alternateScoutData, events, fieldImages, matchComments, matchSchedule, pitScoutImages, pitScouting, seasons, startingPositions, users } from "./schema.js";
